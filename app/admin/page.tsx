  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-orange-600/20 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <nav className="bg-linear-to-r from-slate-900 to-slate-800 shadow-lg sticky top-0 z-40 border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="bg-linear-to-br from-orange-500 to-orange-600 p-2 rounded-xl">
              <Image src="/image/2.png" alt="Logo" width={24} height={24} />
            </div>
            <span className="text-2xl font-bold bg-linear-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">{t("admin.brand")}</span>
          </div>
          <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 relative z-10">
        ...
        <div className="max-w-2xl mx-auto">
          <Link href="/admin/dashboard" className="block group">
            <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl p-12 border-2 border-orange-500/50 hover:border-orange-500 hover:shadow-2xl hover:shadow-orange-500/20 transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center justify-center mb-6">
                <div className="bg-linear-to-br from-orange-500 to-orange-600 p-4 rounded-xl group-hover:scale-125 transition-transform">
              ...
              <div className="flex items-center justify-center gap-2 text-orange-400 font-semibold group-hover:gap-4 transition-all">
      ...
      {/* Footer */}
      <footer className="border-t border-orange-500/30 bg-slate-900/80 backdrop-blur relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between text-slate-300 text-sm">
          ...
          <span className="flex items-center gap-2 text-slate-400">
            ...
            <div className="h-1 w-1 rounded-full bg-orange-500" aria-hidden />
            2026
          </span>
        </div>
      </footer>
